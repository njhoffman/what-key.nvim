...
function M.setup(wk, config)
  local insert = require('what-key.plugins.presets.extra.insert')
  local normal_misc = require('what-key.plugins.presets.extra.normal-misc')
  local command_line = require('what-key.plugins.presets.extra.command-line')
  ...
  local visual = require('what-key.plugins.presets.extra.visual')
